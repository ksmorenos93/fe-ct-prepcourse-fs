...
console.log(obtenerMayor(24,24))
...
function operadoresLogicos(num1, num2, num3) {
   ...
   else if (num3=num2=num1===0){return "Error";}
   else {return false}
   
}
console.log(operadoresLogicos(0,4,15))
