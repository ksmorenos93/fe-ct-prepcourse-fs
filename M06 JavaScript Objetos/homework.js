...
console.log(crearGato("Amor","2 años"));
...
console.log(nuevoUsuario("pepito","pepito_perez@email.com","pepito_perez_password"))
...
console.log(agregarPropiedad({nombre:"nombre",email:"email", password:"password"},"ciudad"))
...
//console.log(invocarMetodo({nombre:"nombre",email:"email", password:"password"},"ciudad"))
